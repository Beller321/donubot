...
@bot.on(poci_cmd(outgoing=True, pattern="magisk$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
