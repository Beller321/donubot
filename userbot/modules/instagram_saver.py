...
CMD_HELP.update(
    {
        "instagram_saver": f"**Plugin : **`instagram_saver`\
        \n\n  •  **Syntax :** `{cmd}igsaver` <link>\
        \n  •  **Function : **Download Postingan di Instagram, Silahkan Salin Link Postingan Instagram Yang Ingin Anda Download Terus Kirim Link, Lalu Reply dan Ketik `.igsaver.\
    "
    }
)
