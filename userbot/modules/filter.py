...
@bot.on(poci_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"filters$"))
