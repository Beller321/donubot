...
@bot.on(poci_cmd(outgoing=True, pattern=r"lastfm$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"lastbio (on|off)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"lastlog (on|off)"))
