...
from userbot.utils import edit_delete, cilik_cmd, reply_id
...
@cilik_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/CilikProject:same> [Support]<buttonurl:https://t.me/CilikSupport>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/CilikProject:same> [Support]<buttonurl:https://t.me/CilikSupport>`\
    "
    }
)
