...
from userbot.utils import edit_or_reply, load_module, cilik_cmd, remove_plugin, reply_id


@cilik_cmd(pattern="install$")
async def _(event):
    if event.fwd_from:
        return
...
@cilik_cmd(pattern="uninstall (?P<shortname>\w+)")
